      ...
      <h2 className={themeStatus ? "text-dark" : "text-light"}>SKILLS</h2>
        <div className="services-sub-container" >
          <div className="services-sub-container2">
            ...
            <h3 className={themeStatus ? "text-dark-2" : "text-light-2"}>Web Development</h3>
            <p className={themeStatus ? "text-dark-2" : "text-light-2"}>Dynamic webpages and SPAs development with the use of HTML, CSS, JavaScript and React with Context, Hooks, Router. REST APIs consumption.</p>
          </div>
          <div className="services-sub-container2">
            <FontAwesomeIcon icon={faLaptopCode} className={themeStatus ? "icon-dark-2" : "icon-light-2"}/>
            <h3 className={themeStatus ? "text-dark-2" : "text-light-2"}>Web Design</h3>
            <p className={themeStatus ? "text-dark-2" : "text-light-2"}>Web pages with responsive design, in other words, adaptable for different screen sizes to make them always look good and and easy to use.</p>
          </div>
          <div className="services-sub-container2">
            <FontAwesomeIcon icon={faCodeBranch} className={themeStatus ? "icon-dark-2" : "icon-light-2"}/>
            <h3 className={themeStatus ? "text-dark-2" : "text-light-2"}>Code Branching</h3>
            <p className={themeStatus ? "text-dark-2" : "text-light-2"}>Managament of code branching with the use of Git which allows to teamwork without impacting other developers.</p>
          </div>
        </div>
