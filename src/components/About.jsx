      ...
      <div className="about-container">
        ...
        <div className="about-sub-container">
          ...
          <p className={themeStatus ? "text-dark-2" : "text-light-2"}>
            I'm Diego, a 31 years old Front-End Developer from México, currently
            studying in{" "}
            <a
              href="https://www.academlo.com/"
              target="blank"
              className={themeStatus ? "text-dark" : "text-light"}
            >
              Academlo
            </a>{" "}
          ...
          <div className="icons-container">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100069878761209"
              target="blank"
              className={themeStatus ? "icon-dark" : "icon-light"}
            >
